 ...
 */
final class Version20210628122958 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE message_sujet (id INT AUTO_INCREMENT NOT NULL, sujet_id INT DEFAULT NULL, message LONGTEXT DEFAULT NULL, date DATETIME DEFAULT NULL, INDEX IDX_D1B5A6767C4D497E (sujet_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE sujet (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) DEFAULT NULL, short_description LONGTEXT DEFAULT NULL, long_description LONGTEXT DEFAULT NULL, date DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
